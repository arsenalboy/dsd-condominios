...
namespace Architects.Persistencia
{
    public class ResidenteDAO
    {
        ...
        {
            objconeccion = new SqlConnection(CadenaConexionSQL);
            SqlCommand objcomand = new SqlCommand("traer_residente", objconeccion);
            objcomand.CommandType = CommandType.StoredProcedure;
            objcomand.Parameters.Add("@N_IdResidente", SqlDbType.Int);
            objcomand.Parameters["@N_IdResidente"].Value = n_IdResidente;
            objconeccion.Open();
            SqlDataReader reader = objcomand.ExecuteReader();
        ...
        public Int32 CreaResidente(Residente objresidente)
        {
            try
            {
                ...
                objcomand.Parameters["@C_Apellidos"].Value = objresidente.C_Apellidos;
        ...
        public Int32 ActualizaResidente(Residente objresidente)
        {
            ...
            {
                objconeccion = new SqlConnection(CadenaConexionSQL);
                SqlCommand objcomand = new SqlCommand("actualiza_residente", objconeccion);
                objcomand.CommandType = CommandType.StoredProcedure;
                objcomand.Parameters.Add("@N_IdResidente", SqlDbType.Int);
                objcomand.Parameters["@N_IdResidente"].Value = objresidente.N_IdResidente;
                objcomand.Parameters.Add("@C_Nombre", SqlDbType.VarChar, 80);
                objcomand.Parameters["@C_Nombre"].Value = objresidente.C_Nombre;
                objcomand.Parameters.Add("@C_Apellidos", SqlDbType.VarChar, 100);
                objcomand.Parameters["@C_Apellidos"].Value = objresidente.C_Apellidos;
