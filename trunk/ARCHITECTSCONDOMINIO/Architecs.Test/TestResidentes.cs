...
using Architecs.Test.WSResidente;
using System.ServiceModel;

namespace Architecs.Test
{
    [TestClass]
    public class TestResidentes
    {
        WSResidente.ResidenteServiceClient client = new WSResidente.ResidenteServiceClient();
        ...
        public void Test_CrearResidente()
        {
            ...
            nuevoResidente.C_NumDocume = "83244401";
