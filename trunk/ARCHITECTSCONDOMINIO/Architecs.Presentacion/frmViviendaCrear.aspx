        ...
        <table>
            <tr>
                ...
                <td style="width: 300px;">
                    <asp:Label ID="lblN_IdVivienda" runat="server" 
                        CssClass="form-control" Width="299px"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtC_NumEdificio" runat="server" CssClass="form-control"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtC_NumDpto" runat="server" CssClass="form-control"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="txtN_NumMetros" runat="server" CssClass="form-control"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlC_CodTipo" runat="server" CssClass="form-control" 
            ...
            <tr>
                ...
                <td>
                    <asp:CheckBox ID="chkB_Estado" runat="server" CssClass="form-control" 
                        Checked="True" />
                </td>
            </tr>
            <tr>
            <td>
                <asp:Button ID="btnGuardar" runat="server" Text="Guardar" 
                    class="btn btn-primary" onclick="btnGuardar_Click"  /></td>
            <td>
                <asp:Button ID="btnCerrar" runat="server" Text="Cerrar"  class="btn btn-primary" /></td>
            </tr>
        </table>
    </fieldset>
    </form>
